        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <button
                onClick={onBack}
                className="hover:bg-purple-700 px-3 py-2 rounded-lg transition-colors"
              >
                ← Atrás
              </button>
              <h1 className="text-xl font-bold">Cartas - Confirmación 2026</h1>
            </div>
            ...
            <div>
              <select
                ...
                className="bg-purple-700 text-white px-4 py-2 rounded-lg border border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-300"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {gruposDisponibles.map((grupo) => (
                <button
                  ...
                  className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-lg hover:border-purple-500 hover:shadow-lg transition-all transform hover:scale-105 text-left"
                >
