...
export const calendarioSeguridad = [
  ...
  { numero: 10, nombre: 'Confirmados en la fe por el espíritu', grupoPresentador: 'Fortaleza' },
  { numero: 11, nombre: 'Fortalecidos por la Eucaristía', grupoPresentador: 'Consejo' },
  { numero: 12, nombre: 'Reconciliados por el espíritu', grupoPresentador: 'Sabiduria' },
  { numero: 13, nombre: 'La confirmación mi pentecostés', grupoPresentador: 'Temor de Dios' },
  { numero: 14, nombre: 'La confirmación es una fiesta de la comunidad', grupoPresentador: 'Piedad' },
  { numero: 15, nombre: 'El espíritu nos llama a servir', grupoPresentador: 'Ciencia' },
  { numero: 16, nombre: 'Testigos de Cristo para hacer un mundo nuevo', grupoPresentador: 'Entendimiento' },
  { numero: 17, nombre: 'Llevados al desierto para elegir a Dios / Elegidos por Jesús, para contemplarlo (fusión)', grupoPresentador: 'Fortaleza' },
  { numero: 18, nombre: 'Saciados del agua que da vida', grupoPresentador: 'Consejo' },
  { numero: 19, nombre: 'Sanados por la luz / Confiados en las promesas de Jesús (fusión)', grupoPresentador: 'Sabiduria' },
];
